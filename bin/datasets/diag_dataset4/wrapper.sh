...
dataset="dataset_12_18_22"
# python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 5000 --k 8 --dataset $dataset --seq_mode 'pcs'
# mv "~/${dataset}" /project2/depablo/erschultz
#
# cd "/home/erschultz/${dataset}"
# tar -czvf setup.tar.gz setup

sourceFile=~/TICG-chromatin/bin/datasets/diag_dataset4/diag_dataset_fns.sh
