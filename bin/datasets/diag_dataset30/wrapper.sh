...
# replaces dataset_02_27_23 which had grid_size 28.7(?)
# python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 5000 --k 7 --m 512 --dataset $dataset --seq_mode 'eig_norm_v2' --chi_param_version 'v13' --diag_mode 'max_ent_v2' --data_dir '/project2/depablo/erschultz'
#
...
sourceFile=~/TICG-chromatin/bin/datasets/diag_dataset30/diag_dataset_fns.sh
