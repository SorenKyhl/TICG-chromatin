...
# python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 5000 --b 261 --phi 0.01 --k 0 --m 512 --dataset $dataset --seq_mode 'none' --plaid_mode 'none' --diag_mode 'meanDist_S_grid' --data_dir '/project2/depablo/erschultz'
#
