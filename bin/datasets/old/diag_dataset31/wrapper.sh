...
python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 5000 --k 8 --m 512 --dataset $dataset --seq_mode 'eig_norm_v2' --chi_param_version 'v13' --diag_mode 'max_ent_linear_v2_grid' --data_dir '/project2/depablo/erschultz'
#
...
sourceFile=~/TICG-chromatin/bin/datasets/diag_dataset31/diag_dataset_fns.sh
