...
dataset="dataset_09_27_23"
echo "generate_params for ${dataset}"
# uses poly6 fit to max ent params + grid
# python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 10000 --b 180 --phi 0.008 --k 5 --ar 1.5 --m 512 --dataset $dataset --seq_mode 'eig_norm' --diag_mode 'meanDist_S_grid' --data_dir '/project2/depablo/erschultz'
#
...
sourceFile=~/TICG-chromatin/bin/datasets/diag_dataset56/diag_dataset_fns.sh
start=1
end=2000
for i in {1..5}
do
