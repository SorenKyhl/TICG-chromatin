...
dataset="dataset_09_16_23"
echo "generate_params for ${dataset}"
# uses poly6 fit to max ent params + grid
# python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 10 --b 180 --phi 0.01 --k 10 --ar 2.0 --m 512 --dataset $dataset --seq_mode 'eig_norm' --plaid_mode 'KDE' --diag_mode 'max_ent_poly6_log_grid' --data_dir '/home/erschultz'
#
...
# rm -r samples
#
sourceFile=~/TICG-chromatin/bin/datasets/diag_dataset51/diag_dataset_fns.sh
for i in 1
do
  echo $i
