...
dataset="dataset_08_24_23_v3"
echo "generate_params for ${dataset}"
# uses poly6 fit to max ent params + grid
python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 15 --b 261 --phi 0.01 --k 10 --m 512 --dataset $dataset --seq_mode 'eig_norm' --plaid_mode 'KDE' --diag_mode 'max_ent_grid' --data_dir '/home/erschultz'
#
