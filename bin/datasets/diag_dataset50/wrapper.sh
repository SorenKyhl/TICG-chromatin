...
# uses poly6 fit to meandist S + grid
# python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 5000 --b 180 --phi 0.01 --k 10 --ar 2.0 --m 512 --dataset $dataset --seq_mode 'eig_norm' --plaid_mode 'KDE' --diag_mode 'meanDist_S_grid' --data_dir '/project2/depablo/erschultz'
#
...
sourceFile=~/TICG-chromatin/bin/datasets/diag_dataset50/diag_dataset_fns.sh
for i in 6 7 8 9 10
do
  echo $i
