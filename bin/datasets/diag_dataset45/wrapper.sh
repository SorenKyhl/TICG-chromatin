...
# python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 15 --b 261 --phi 0.01 --k 10 --m 512 --dataset $dataset --seq_mode 'eig_norm' --plaid_mode 'KDE' --diag_mode 'meanDist_S_grid' --data_dir '/home/erschultz'
#
