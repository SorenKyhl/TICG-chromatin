...
# varied grid_size
# python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 5000 --k 4 --m 512 --dataset $dataset --seq_mode 'eig_norm' --chi_param_version 'v13' --diag_mode 'linear_v2' --grid_mode 'v1'
#
...
sourceFile=~/TICG-chromatin/bin/datasets/diag_dataset23/diag_dataset_fns.sh
