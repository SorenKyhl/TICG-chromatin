...
# varied grid_size
# python  ~/TICG-chromatin/bin/datasets/generate_params.py --samples 5000 --k 8 --m 512 --dataset $dataset --seq_mode 'eig_norm' --chi_param_version 'v13' --diag_mode 'linear_v2' --grid_mode 'v1'
#
